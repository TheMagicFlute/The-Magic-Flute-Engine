...
global.versionDataUrl = "https://raw.githubusercontent.com/TheMagicFlute/The-Magic-Flute-Engine/main/The-Magic-Flute-Engine-current-version.json"; // the original link is "https://pastebin.com/raw/Z5sWFNap"
global.gameVersion = "0.1";
...
global.roomCaptionDef = "The-Magic-Flute-Engine";  //Sets default window caption (only works with the Professional version of Studio)
...
global.md5StrAdd = "FranzLisztIsGod"; //sets what to add to the end of md5 input string to make the save harder to mess with, can be changed to anything, should be set to something unique and hard to predict (like setting a password)
